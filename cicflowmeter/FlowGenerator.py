...
from cicflowmeter.BasicPacketInfo import BasicPacketInfo
from cicflowmeter.BasicFlow import BasicFlow
from cicflowmeter import FlowFeature
...
class FlowGenerator:
    ...
    def dumpFeatureToCSV(self,save_path):
        # 将流量统计特征保存到CSV文件
